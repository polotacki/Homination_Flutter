...
class SearchPage extends StatelessWidget {
  SearchPage(
      {Key? key, required this.query, required this.service, required this.filter})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return
      BlocProvider(
        create: (context) =>
        SearchCubit(servicesModel: service, filters: filter)
          ..searchQueryChanged(service, filter),
        child: BlocConsumer<SearchCubit, SearchState>(
          ...
          builder: (context, state) {
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        cubit.searchQueryChanged(service, filter);
                      },
            ...
            onPressed: () async {
            List<Filter>? updatedSearchFilter = await
            ...
            if (updatedSearchFilter != null &&
            !listEquals(updatedSearchFilter, searchFilter)) {
            searchFilter = updatedSearchFilter;
            cubit.searchQueryChanged(service, searchFilter);
            }
            },
    ...
    child: Padding(padding: EdgeInsets.only(top: 100.h),
    child: Lottie.asset(
